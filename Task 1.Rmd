...
library(GGally)
library(Rtsne)
# library(corrplot) # extra - not included in workshop
# library(factoextra) # not included in workshop
```
...
# just using some other code to explore
# pcavar <- get_pca_var(pca)
# corrplot(pcavar$cos2, is.corr=FALSE)
